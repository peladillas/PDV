...
Class Factura_compras extends MY_Controller {

    protected $path = 'factura_compras/';
    ...
    function add() {
        ...
        $db['documents']->set_table_head('factura_compra', 'id_factura_compra');
        $db['documents']->set_entity('id_proveedor', 'proveedor');

        $db['documents']->set_table_detail('renglon_factura_compra');
