...
$db['local']['password'] = '';
$db['local']['database'] = 'sarmiento-nuevo';
...
$db['remote']['hostname'] = '54.39.49.92';
$db['remote']['username'] = 'estud288_pdv';
$db['remote']['password'] = 'Salchichon90';
$db['remote']['database'] = 'estud288_pdv';
